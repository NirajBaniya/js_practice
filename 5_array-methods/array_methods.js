...
const avengers = ["CaptAmerica","thor","ironMan","Hulk",
,"drStrang"];
avengers.push("batMan","SpiderMan" , "Hello");
...
avengers.unshift("First is added", "av2");
console.log(avengers)
...
//Splice method contain three parameters
...
const brands =["apple", "Dell", "Lenovo", "Samsung", "acer"];
brands.splice(2, 1, "hp", "asus");
console.log(brands)

//10. Slice (Slice out the element of the Array ) elment haru xuttau xa 
const bike_brands = ["Honda", "Suzuki", "bmw", "harleyDavidson","Ducati"];
console.log(bike_brands)
const new_bike_brands = bike_brands.slice(0, 3)
